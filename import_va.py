...
# Truncate existing va table to ensure fresh import
...
for idx, row in df.iterrows():
    ...
    mid = None # Mid column added right after id, left NULL as specified
...
print(f"Successfully imported {cursor.rowcount} rows into table 'va'!")
