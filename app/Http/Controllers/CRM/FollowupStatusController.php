...
class FollowupStatusController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        try {
            ...
            $followupStatuses = $query->get(['id', 'name', 'color', 'description', 'followup_type_id']);
    ...
    public function store(Request $request): JsonResponse
    {
        try {
            ...
            $validated['created_by'] = $request->get('user')->id;
            $validated['admin_id'] = $request->get('admin')->id;
    ...
    {
        try {
            $followupStatus->load('followupType');
