...
const MatmHistory = ({ isHeader = true }) => {
  ...
  // Remove isHeader state, use prop instead
  ...
  const fetchTransactions = async (page = 1, perPage = 50, filters = {}) => {
    ...
    try {
      ...
      setUniqueShops(response.data.unique_shops || []);
  ...
  const maskMobile = (mobile) => {
    ...
    const handleViewReceipt = (transaction) => {
        var x=JSON.parse(transaction.request);
        setReceiptData(x.data);
  ...
  return (
    <>
      {isHeader ?  
      <Pageheader
        mainheading="MATM Transaction History"
        parentfolder="MATM"
                  ...
                  <div className="row g-2 align-items-center">
                    ...
                    <div className="col-auto">
                      ...
                      >
                        ...
                        <option value="MATMBE">Balance Enquiry</option>
                        <option value="MATMCW">Cash Withdrawal</option>
                      </select>
                    </div>
                            ...
                            },
                            {
                              ...
                              Cell: ({ row }) => (
                                <button
                                  ...
                                  title="View Receipt"
                                >
                                  <i className="fa fa-receipt text-primary"></i> View
                                </button>
                              ),
                            },
                          ]}
