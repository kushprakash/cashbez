...
const Home = () => {
    ...
    const [selectedMode, setSelectedMode] = useState('CD'); // CD, MINI, BE, M
    ...
    const getBankList = async () => {
        ...
        const response = await apiService.vPost('/api/v2/cash-deposit/bank-list', {});
    ...
    const moveToNextVerification = async () => {
        ...
        try {
            const apiService = ApiService();
            const response = await apiService.vPost('/api/v2/aeps/draft-data', {});
    ...
    const validateBeforeCapture = () => {
        ...
        // For AP and CD modes, amount is also required
        if (selectedMode === 'AP' || selectedMode === 'CD') {
    ...
    const validateField = (name, value) => {
        ...
        switch (name) {
            ...
            case 'aadharNo':
                ...
                break;
            case 'amount':
                if ((selectedMode === 'CD' || selectedMode === 'M')) {
                    if (!value) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await apiService.vPost('/api/v2/cash-deposit/process', {
            ...
            {loading2FA && (
                <div style={{
                    ...
                    <div style={{
                        ...
                        <div style={{ color: '#6c5ce7', fontWeight: 500, fontSize: 18 }}>Checking authentication...</div>
                    </div>
                </div>
            )}
            ...
            <div className="card" style={styles.container}>
                <div className='card-header' style={styles.header}>
                    <div className="d-flex justify-content-between align-items-center">
                        <div className="d-flex align-items-center gap-1">
                            ...
                            <div>
                                <h5 className="mb-0">Cash Deposit Transaction</h5>
                ...
                <div className='card-body'>
                    ...
                    <form onSubmit={handleSubmit} className='mt-3 card p-3'>
                        ...
                        {(selectedMode === 'CD' || selectedMode === 'M') && (
                            <div style={styles.formSection}>
