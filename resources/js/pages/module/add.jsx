...
const AddModule = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const apiService = ApiService();
            const response = await apiService.vPost('/api/modules', formData, true, true);
            const { data } = response;
            if (data.status !== 1) {
    ...
    return (
        <>
            <Pageheader mainheading="Module Master" parentfolder="Modules" activepage="Create" />
                        ...
                        <div className="card">
                            <div className="card-header d-flex justify-content-between align-items-center rounded-top">
                                <span className="d-flex align-items-center">
                                    ...
                                    <h5 className="mb-0 fw-semibold">Add Module</h5>
                                </span>
