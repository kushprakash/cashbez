...
const AddUser = () => {
    ...
    React.useEffect(() => {
        ...
        apiService.vGet('/api/roles').then(response => {
    ...
    const handleReferCheck = async () => {
        ...
        try {
            ...
            if (res.data && res.data.status === 1 && res.data.user) {
                ...
                setReferName('');
                toast.error(res.data.message || 'Refer ID not found');
            }
        } catch (err) {
            setReferName('');
            toast.error(err?.response?.data?.message || 'Refer ID not found');
        }
    };
    ...
    const validate = () => {
        ...
        if (!form.aadhar_number) errs.aadhar_number = 'Aadhar number is required';
        if (!form.refer_by) errs.refer_by = 'Refer ID is required';
        if (!form.status) errs.status = 'Refer ID is required';
        return errs;
    };
    ...
    return (
        <>
            ...
            <Pageheader mainheading="Users Master" parentfolder="Users" activepage="Create" />
                            ...
                            <div className="card">
                                <div className="card-header d-flex justify-content-between align-items-center rounded-top">
                                    <span className="d-flex align-items-center">
                                        ...
                                        <h5 className="mb-0 fw-semibold">Create User</h5>
                                    </span>
