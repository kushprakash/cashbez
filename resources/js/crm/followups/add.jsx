...
const AddFollowup = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            const response = await apiService.vPost('/api/crm/followups', formData);
    ...
    return (
        <>
            <Pageheader 
                currentpage="Schedule Follow-up" 
                activepage="CRM" 
                ...
                <div className="col-lg-8">
                    <div className="card">
                        <div className="card-header">
                            <h5 className="card-title mb-0">Schedule New Follow-up</h5>
                        </div>
                        ...
                        <div className="card-body">
                            <ul className="list-unstyled">
                                <li className="mb-2">
                                    ...
                                    <small>Schedule follow-ups at optimal times for your leads</small>
                                </li>
                                <li className="mb-2">
                                    <i className="fa fa-check text-success me-2"></i>
                                    <small>Add detailed notes for context</small>
                                </li>
                                <li className="mb-2">
                                    <i className="fa fa-check text-success me-2"></i>
                                    <small>Set realistic time expectations</small>
                                </li>
                                <li className="mb-2">
                                    <i className="fa fa-check text-success me-2"></i>
                                    <small>Use different follow-up types strategically</small>
                                </li>
                            </ul>
                        </div>
                    </div>
