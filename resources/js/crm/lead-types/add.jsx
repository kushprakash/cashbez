...
const AddLeadType = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            const response = await apiService.vPost('/api/crm/lead-types', formData);
            ...
            toast.error(error.response?.data?.message || 'Error creating lead type. Please try again.');
        } finally {
            setLoading(false);
        }
    };
                ...
                <div className="col-lg-8">
                    <div className="card">
                        <div className="card-header">
                            <h5 className="card-title mb-0">Add New Lead Type</h5>
                        </div>
