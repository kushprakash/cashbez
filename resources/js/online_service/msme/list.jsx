...
const MsmeList = () => {
    ...
    const fetchApplications = async () => {
        ...
        try {
            ...
            const response = await apiService.vGet('/api/online-service/msme');
    ...
    return (
        <>
            <Pageheader mainheading="MSME Applications" parentfolder="MSME" activepage="List" />
                ...
                <div className="page-content-box-inner">
                    <div className="card shadow-sm border-0">
                        <div className="card-header d-flex justify-content-between align-items-center bg-white border-bottom py-3">
                            ...
                            <Link to="/msme/create" className="btn btn-primary d-flex align-items-center gap-2">
                                        ...
                                        <tbody>
                                            {applications.length > 0 ? applications.map((item, index) => (
                                                <tr key={item.id}>
                                                    ...
                                                    <td className="fw-medium text-dark">{item.shop_name}</td>
                                                    <td className="fw-medium text-dark">{item.owner_name}</td>
