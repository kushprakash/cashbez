...
const MsmeDashboard = () => {
    ...
    useEffect(() => {
        const fetchStats = async () => {
            ...
            try {
                ...
                const response = await apiService.vGet('/api/online-service/msme/dashboard');
    ...
    return (
        <>
            <Pageheader mainheading="MSME Dashboard" parentfolder="MSME" activepage="Dashboard" />
                    ...
                    <div className="row g-4 mb-4">
                        ...
                        <div className="col-md-3">
                            <div className="card shadow-sm border-0 bg-warning text-dark h-100">
                                <div className="card-body">
                                    <h6 className="opacity-75 mb-2">Processing</h6>
                        ...
                        <div className="col-md-6">
                            <div className="card shadow-sm border-0 h-100">
                                <div className="card-body text-center py-5">
                                    <i className="fa fa-industry text-primary opacity-25" style={{ fontSize: '4rem' }}></i>
                                    <h4 className="mt-3 fw-bold">New MSME Application</h4>
                                    <p className="text-muted mb-4">Apply for a new MSME registration easily.</p>
                                    <Link to="/msme/create" className="btn btn-primary px-4 py-2">Apply Now</Link>
                                </div>
                            </div>
                        </div>
                        <div className="col-md-6">
                            <div className="card shadow-sm border-0 h-100">
                                <div className="card-body text-center py-5">
                                    ...
                                    <Link to="/msme/list" className="btn btn-outline-primary px-4 py-2">View List</Link>
                                </div>
                            </div>
                        </div>
                    </div>
