...
const MsmeAdminDashboard = () => {
    ...
    const fetchData = async () => {
        ...
        try {
            const [statsRes, listRes] = await Promise.all([
                apiService.vGet('/api/online-service/msme/admin-dashboard'),
                apiService.vGet('/api/online-service/msme/admin/list')
            ]);
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            // Update Status
            const statusRes = await apiService.vPut(`/api/online-service/msme/${selectedApp.id}/status`, updateForm);
            ...
            if (receiptFile) {
                ...
                const receiptRes = await apiService.postWithFile(`/api/online-service/msme/${selectedApp.id}/receipt`, {}, { aplication_reciept: receiptFile });
    ...
    return (
        <>
            <Pageheader mainheading="MSME Admin Dashboard" parentfolder="MSME" activepage="Admin" />
                                    ...
                                    <table className="table table-hover mb-0 align-middle">
                                        <thead className="bg-light">
                                            <tr>
                                                ...
                                                <th className="py-3">Shop Details</th>
                                        ...
                                        <tbody>
                                            {applications.map((app, index) => (
                                                <tr key={app.id}>
                                                    ...
                                                    <td>
                                                        <div className="fw-medium text-dark">{app.shop_name}</div>
                                                        <small className="text-muted d-block">{app.owner_name}</small>
                                ...
                                <div className="row g-4">
                                    <div className="col-md-6">
                                        ...
                                        <dl className="row mb-0">
                                            ...
                                            <dd className="col-sm-7 fw-medium">{selectedApp.owner_name}</dd>

                                            <dt className="col-sm-5 text-secondary fw-normal">Shop Name</dt>
                                            <dd className="col-sm-7 fw-medium">{selectedApp.shop_name}</dd>

                                            <dt className="col-sm-5 text-secondary fw-normal">Shop Address</dt>
                                            <dd className="col-sm-7">{selectedApp.shop_address}</dd>
                                            ...
                                            <dt className="col-sm-5 text-secondary fw-normal">Account No.</dt>
                                            <dd className="col-sm-7">{selectedApp.account_number}</dd>

                                            <dt className="col-sm-5 text-secondary fw-normal">IFSC Code</dt>
                                            <dd className="col-sm-7">{selectedApp.ifsc_code}</dd>
                                        </dl>
                                    </div>
                                    <div className="col-md-6">
                                        ...
                                        <div className="d-flex flex-column gap-2">
                                            ...
                                            <a href={`${selectedApp.bank_passbook}`} target="_blank" rel="noopener noreferrer" className="btn btn-light btn-sm text-start border"><i className="fa fa-file me-2 text-secondary"></i> Bank Passbook</a>
...
export default MsmeAdminDashboard;
