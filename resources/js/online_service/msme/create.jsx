...
const CreateMsme = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        const fileFields = [
            ...
            { name: 'bank_passbook', label: 'Bank Passbook (First Page)' }
        ];
        ...
        try {
            ...
            for (const field of fileFields) {
                if (files[field.name]) {
                    const result = await uploadToBunny(files[field.name], 'msme_documents');
                    if (result.success) {
            ...
            // Remove confirm_account_number from payload (not needed for backend)
            const { confirm_account_number, ...payloadData } = formData;

            // Combine payload with file URLs
            const finalPayload = { ...payloadData, ...fileUrls };

            // Send to backend (URLs only, no files)
            const response = await apiService.vPost('/api/online-service/msme', finalPayload);
    ...
    return (
        <>
            <Pageheader mainheading="Apply for MSME" parentfolder="MSME" activepage="Create" />
            <div className="page-content-box">
                <div className="page-content-box-inner">
                    <form onSubmit={handleSubmit}>

                        {/* Card 1: Personal & Shop Details */}
                        <div className="card shadow-sm border-0 mb-4">
                            <div className="card-header bg-white border-bottom py-3 px-4">
                                <h5 className="mb-0 fw-bold text-primary">Personal & Shop Details</h5>
                            </div>
                            <div className="card-body p-4">
                                <div className="row g-4">
                                    <div className="col-md-4">
                                        <div className="form-group">
                                            <label className="form-label fw-medium">Owner Name <span className="text-danger">*</span></label>
                                            <div className="input-group">
                                                <span className="input-group-text bg-light border-end-0"><i className="fa fa-user text-secondary"></i></span>
                                                <input type="text" className="form-control border-start-0 ps-0" placeholder="Enter Owner Name" name="owner_name" value={formData.owner_name} onChange={handleInputChange} required />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-md-4">
                                        <div className="form-group">
                                            <label className="form-label fw-medium">Shop Name <span className="text-danger">*</span></label>
                                            <div className="input-group">
                                                <span className="input-group-text bg-light border-end-0"><i className="fa fa-store text-secondary"></i></span>
                                                <input type="text" className="form-control border-start-0 ps-0" placeholder="Enter Shop Name" name="shop_name" value={formData.shop_name} onChange={handleInputChange} required />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-md-4">
                                    ...
                                    <div className="col-md-8">
                                        <div className="form-group">
                                            <label className="form-label fw-medium">Shop Address <span className="text-danger">*</span></label>
                                            <div className="input-group">
                                                <span className="input-group-text bg-light border-end-0"><i className="fa fa-location-dot text-secondary"></i></span>
                                                <input type="text" className="form-control border-start-0 ps-0" placeholder="Enter Complete Shop Address" name="shop_address" value={formData.shop_address} onChange={handleInputChange} required />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-md-4">
                                ...
                                <div className="row g-4">
                                    <div className="col-md-4">
                                        <div className="form-group">
                                            ...
                                            <div className="input-group">
                                                <span className="input-group-text bg-light border-end-0"><i className="fa fa-building-columns text-secondary"></i></span>
                                                <input type="text" className="form-control border-start-0 ps-0" placeholder="Enter Account Number" name="account_number" value={formData.account_number} onChange={handleInputChange} required />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-md-4">
                                        <div className="form-group">
                                            <label className="form-label fw-medium">Confirm Account Number <span className="text-danger">*</span></label>
                                            <div className="input-group">
                                                <span className="input-group-text bg-light border-end-0"><i className="fa fa-building-columns text-secondary"></i></span>
                                                <input type="text" className="form-control border-start-0 ps-0" placeholder="Re-enter Account Number" name="confirm_account_number" value={formData.confirm_account_number} onChange={handleInputChange} required />
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-md-4">
                                        <div className="form-group">
                                            ...
                                            <div className="input-group">
                                                <span className="input-group-text bg-light border-end-0"><i className="fa fa-code text-secondary"></i></span>
                                                <input type="text" className="form-control border-start-0 ps-0" placeholder="Enter IFSC Code" name="ifsc_code" value={formData.ifsc_code} onChange={handleInputChange} required />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="d-flex justify-content-end gap-3 mb-5">
                            <button type="button" className="btn btn-lg btn-light border px-4" onClick={() => navigate('/msme/list')}>Cancel</button>
